...
public abstract class BibliotekaInterfejsTest {
	...
	@Test
	@DisplayName("Provera da nije dozvoljeno unosenje knjige duplikata")
	...
	void testPronadjiKnjigu() {
		...
		List<Knjiga> knjige = biblioteka.pronadjiKnjigu(null, -1, "VIH", null);
	...
	void testPronadjiKnjiguViseKnjiga() {
		...
		List<Knjiga> knjige = biblioteka.pronadjiKnjigu(null, -1, "PR", null);
	...
	void testPronadjiKnjiguNemaRezultata() {
		...
		List<Knjiga> knjige = biblioteka.pronadjiKnjigu(null, -1, "Pera", null);
